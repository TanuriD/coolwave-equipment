...
const iceMachinesData = {
  ...
  "direct-cool-block-ice-machine": {
    ...
    image: "/direct cool block ice machine 4.png",
  ...
  if (!machine) {
    return (
      <div className="page-section">
        ...
        <p>The ice machine you're looking for doesn't exist.</p>
        <Link to="/ice-machines" className="back-link">← Back to Ice Machines</Link>
      </div>
    );
  }
